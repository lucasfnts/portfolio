        ...
        <nav class="flex h-9 items-center justify-between" aria-label="Global">
          <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
            <a href="#" class="-m-1.5 p-1.5">
              <span class="sr-only">Lucas FUENTES</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
          <div>
            <div>
              ...
              >
                Ingénieur Full Stack & Cloud
              </h1>
              <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">
                Basé en Martinique, je suis un Ingénieur Full Stack et Cloud
                fort d'expérience dans différentes industries. <br />Que vous
                ayez besoin d'une <strong>API</strong> pour un service interne,
                un <strong>E.R.P sur mesure</strong> ou un accompagnement vers
                la <strong>souveraineté numérique</strong> de votre entreprise
                je saurais vous guider vers la meilleure solution.
                <br />
                En tant que <strong>D.P.O</strong> (Data Protection Officer ou
                Délégué à la Protection des Données) je peux vous accompagner
                dans votre projet de mise en conformité RGPD. <br />Je
                privilégie les solutions <strong>Open-Source</strong> et
                <strong>respectueuse de la vie privée</strong>.
              </p>
